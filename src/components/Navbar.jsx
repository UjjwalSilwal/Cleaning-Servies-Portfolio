...
const Navbar = () => {
  return (
    <div >
      {/* <!-- ========== HEADER ========== --> */}
<header class="flex flex-wrap md:justify-start md:flex-nowrap z-49 w-full mb-10 ">
  <nav class="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-8 mx-auto">
    ...
    <div id="hs-navbar-hcail" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block md:w-auto md:basis-auto md:order-2 md:col-span-6" aria-labelledby="hs-navbar-hcail-collapse">
      ...
      <div>
          <a class="inline-block text-black hover:text-red-600 focus:outline-none focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-red-600 font-bold" href="/">Home</a>
        </div>
        <div>
          <a class="inline-block text-black hover:text-red-600 focus:outline-none focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-red-600 font-bold" href="/about">About</a>
        </div>
        <div>
          <a class="inline-block text-black hover:text-red-600 focus:outline-none focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-red-600 font-bold" href="/services">Services</a>
        </div>
        <div>
          <a class="inline-block text-black hover:text-red-600 focus:outline-none focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-red-600 font-bold" href="/contact">Contact</a>
        </div>
      </div>
    </div>
    {/* <!-- End Collapse --> */}
